      ...
      <div className="w-full bg-[#ffffffcc] fixed top-0 border-b border-b-gray-100 z-50 backdrop-blur-sm">
        <div className="flex justify-between px-5 py-3 max-w-[90vw] items-center box-border mx-auto my-0">
          ...
          <div className="flex gap-9 text-[#111]">
            <p className="text-sm cursor-pointer hover:text-[#f97316] transition-all duration-200 ease-in-out">
              Home
            </p>
            <p className="text-sm cursor-pointer hover:text-[#f97316] transition-all duration-200 ease-in-out">
              Posters
          ...
          <div className="flex gap-5">
            ...
            <button
              ...
              <span className="absolute top-0 right-0 translate-x-2 -translate-y-1 rounded-md h-5 w-5 bg-[#f97316] text-white font-medium text-xs items-center justify-center hidden">
                0
              </span>
            </button>
          </div>
      ...
      <div className="justify-center max-w-6xl my-0 mx-auto">
        <div className="mt-22 py-20 flex gap-8 items-center">
          <div className="w-[50%] p-8">
            ...
            <div className="bg-[#f97316] hover:bg-[#ea580c] transition-all duration-150 ease-in-out cursor-default h-12 px-9 py-6 rounded-4xl flex w-fit justify-center items-center text-white text-sm font-semibold">
              Explore Posters
            </div>
          </div>
          ...
          <div className="py-16">
            ...
            <div className="flex flex-col gap-8 w-full">
              ...
              <div className="flex gap-5 w-full">
                {/* card1 */}
                <div className="flex flex-col gap-7 overflow-hidden rounded-2xl posters w-full bg-white transition-all duration-300 ease-in-out hover:shadow-lg">
                  <div className="h-[540px] overflow-hidden z-20 flex items-center justify-center w-full">
                    <img
                      src="/Posters/Firefly 20251112202430.png"
                      alt="poster1"
                      className="transition-all duration-400 ease-in-out overflow-hidden object-cover h-[540px] object-center"
                    />
                  </div>
                  <div className="p-4">
                    <div className="mb-3">
                    ...
                    <div className="flex justify-between py-2 items-center">
                      <div>₹129</div>
                      <div className="rounded-2xl bg-[#f97316] px-6 h-8 text-sm text-white font-medium flex items-center justify-center hover:bg-[#ea580c] transition-colors duration-200 ease-in-out">
                        Add to Cart
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col gap-7 overflow-hidden rounded-2xl posters w-full bg-white transition-all duration-300 ease-in-out hover:shadow-lg">
                  <div className="h-[540px] overflow-hidden z-20 flex items-center justify-center w-full">
                    <img
                      src="/Posters/धैर्यं सर्वत्र साधनम्.png"
                      alt="poster2"
                      className="transition-all duration-400 ease-in-out overflow-hidden object-cover h-[540px] object-center"
                    />
                  </div>
              ...
              <div className="flex gap-5 w-full">
                ...
                <div className="flex flex-col gap-7 overflow-hidden rounded-2xl posters w-full bg-white transition-all duration-300 ease-in-out hover:shadow-lg">
                  <div className="h-[540px] overflow-hidden z-20 flex items-center justify-center w-full">
                    <img
                      src="/Posters/योगः कर्मसु कौशलम्.png"
                      alt="poster4"
                      className="transition-all duration-400 ease-in-out overflow-hidden object-cover h-[540px] object-center"
                    />
                  </div>
                ...
                <div className="flex flex-col gap-7 overflow-hidden rounded-2xl posters w-full bg-white transition-all duration-300 ease-in-out hover:shadow-lg">
                  <div className="h-[540px] overflow-hidden z-20 flex items-center justify-center w-full">
                    <img
                      src="/Posters/poster expanded (1).png"
                      alt="poster5"
                      className="transition-all duration-400 ease-in-out overflow-hidden object-cover h-[540px] object-center"
                    />
                  </div>
                ...
                <div className="flex flex-col gap-7 overflow-hidden rounded-2xl posters w-full bg-white transition-all duration-300 ease-in-out hover:shadow-lg">
                  <div className="h-[540px] overflow-hidden z-20 flex items-center justify-center w-full">
                    <img
                      src="/Posters/विद्या ददाति विनयम्.png"
                      alt="poster6"
                      className="transition-all duration-400 ease-in-out overflow-hidden object-cover h-[540px] object-center"
                    />
                  </div>
